...
export const CURATED_UNIVERSE: Record<string, CuratedEntry> = {
  ...
  QCOM: { sector: "Semiconductors", tags: ["semiconductors", "dividend", "large-cap"], blurb: "Mobile-chip leader (Snapdragon) diversifying into AI PCs and automotive silicon." },
  MU: { sector: "Semiconductors", tags: ["ai", "semiconductors", "high-volatility"], blurb: "Memory-chip maker riding the AI-driven surge in high-bandwidth memory demand." },
  ...
  ORCL: { sector: "Software", tags: ["ai", "software", "large-cap", "dividend"], blurb: "Database giant turned cloud landlord for a chunk of the industry's AI training compute." },
  ADBE: { sector: "Software", tags: ["ai", "software", "large-cap"], blurb: "Creative-software staple weaving generative AI (Firefly) into its core tools." },
  ...
  V: { sector: "Financials", tags: ["dividend", "financials", "large-cap", "quality", "low-volatility"], blurb: "Payments network that tolls a slice of global card spending without holding credit risk." },
  MA: { sector: "Financials", tags: ["dividend", "financials", "large-cap", "quality", "low-volatility"], blurb: "Visa's closest peer in the card-network duopoly, with a near-identical business model." },
